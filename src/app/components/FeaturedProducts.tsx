          ...
          <div className="flex flex-wrap justify-center -m-4">
            ...
            <div className="lg:w-1/5 md:w-1/4 sm:w-1/2 w-full p-4 hover:scale-105 duration-200">
              <span className="block relative h-48 rounded overflow-hidden">
                <h1 className="absolute top-2 left-2 text-white bg-[#01AD5A] p-1 sm:p-2 text-xs rounded-md">
                  New
                </h1>
            ...
            <div className="lg:w-1/5 md:w-1/4 sm:w-1/2 w-full p-4 hover:scale-105 duration-200">
              <span className="block relative h-48 rounded overflow-hidden">
                <h1 className="absolute top-2 left-2 text-white bg-[#F5813F] p-1 sm:p-2 text-xs rounded-md">
                  Sales
                </h1>
                <Image
                  src="/product1.png"
